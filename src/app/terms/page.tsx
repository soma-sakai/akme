      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md overflow-hidden p-8">
          ...
          <div className="prose max-w-none">
            <p className="mb-4">
              この利用規約（以下、「本規約」といいます。）は、Akamee（以下、「当社」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って本サービスをご利用いただきます。
            </p>
            ...
            <h2 className="text-xl font-bold mt-8 mb-4">第6条（利用制限および登録抹消）</h2>
            <ol className="list-decimal pl-8 mb-6 space-y-2">
            ...
            <h2 className="text-xl font-bold mt-8 mb-4">第7条（退会）</h2>
            ...
            <ol className="list-decimal pl-8 mb-6 space-y-2">
              ...
              <li>当社が別途定める場合を除いて、変更後の本規約は、本ウェブサイトに掲載したときから効力を生じるものとします。</li>
            </ol>
