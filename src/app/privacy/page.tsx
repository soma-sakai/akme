      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md overflow-hidden p-8">
          ...
          <div className="prose max-w-none">
            <p className="mb-4">
              Akamee（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
            </p>
            ...
            <p className="mb-6">
              当社は、ユーザーが利用登録をする際に氏名、生年月日、住所、電話番号、メールアドレス、銀行口座番号、クレジットカード番号、運転免許証番号などの個人情報をお尋ねすることがあります。また、ユーザーと提携先などとの間でなされた会員情報の交換の結果、当社が個人情報を取得することがあります。
            </p>
            ...
            <p className="mb-6">
              ...
              住所：東京都渋谷区〇〇〇〇 1-2-3<br />
              社名：Akamee株式会社<br />
              Eメールアドレス：info@akamee.example.com
            </p>
            
            <p className="mt-12 text-right">以上</p>
            <p className="text-right">制定日: 2023年4月1日</p>
          </div>
        </div>
      </div>
    </div>
